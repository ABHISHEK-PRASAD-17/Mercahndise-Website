...
<body>
    ...
    <main class="container">
        ...
        <h2>"Empower the Adventure Within"</h2>
        ...
        <div class="row">
                ...
                <a href="mens.html" target="_blank">
                    <form action="managecarting.php" method="POST">
                        <div>
                            ...
                            <h3>BLACK ANIME OVERSIZE</h3>
                            <p>GOJO SATAROU</p>
                            <p>900</p>
                            <input type="submit" value="cart" name="ADD_TO_CART" class="cart">
                            <input type="hidden" name="Item_Name" value="GOJO ">
            ...
            <div class="column">
                <a href="mensoversize3.jpg" target="_blank">
                    <form action="managecarting.php" method="POST">

                        <div>

                            <img src="mensoversize3.jpg" alt="" width="100%">
                            <h3>PURPLE ANIME OVERSIZE</h3>
                            <p>GOJO SATAROU</p>
                            <p>999</p>
                            <input type="submit" value="cart" name="ADD_TO_CART" class="cart">
                            <input type="hidden" name="Item_Name" value="SATARAO ">
                ...
                <a href="mens.html" target="_blank">
                    <form action="managecarting.php" method="POST">
                        ...
                        <div>
                            ...
                            <img src="mensoversize5.webp" alt="" width="100%">
                            <h3>BLACK ANIME OVERSIZE</h3>
                            <p>SON GOKU</p>
                            <p>1090</p>
                            <input type="submit" value="cart" name="ADD_TO_CART" class="cart">
                            <input type="hidden" name="Item_Name" value="SON GOKU">
                ...
                if ($resultCount > 0) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "
                                ...
                                <div class='column'>
                                    <a href='mens.html' target='_blank'>
                                        <form action='managecarting.php' method='post' class='j'>
                                            <div>
